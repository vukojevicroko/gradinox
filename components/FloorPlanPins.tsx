          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  {active.brojSoba} sobe
                  {active.orijentacija ? ` • ${active.orijentacija}` : ""} •{" "}
            ...
            <div className="mt-5 flex gap-3">
              <Link
                ...
                className="flex-1 rounded-full bg-slate-900 px-5 py-2.5 text-center text-sm font-semibold text-white hover:bg-slate-800"
              >
                Više detalja →
              </Link>
            ...
            <p className="mt-4 text-xs text-slate-500">
              * Statusi i cijene se mijenjaju kroz data file (brzo i bez
              komplikacija).
            </p>
          </div>
        </div>
